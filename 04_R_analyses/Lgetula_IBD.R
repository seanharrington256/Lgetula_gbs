#### Script to look at isolation by distance for L. getula GBS data

### NOTE THAT YOU WILL NEED TO CHANGE FILE PATHS from mine
...
##    links in comments specify data to be downloaded and placed in the directories
main_dir<-"/Users/harrington/Active_Research/Ecotone_genomics/GBS_Data/pop_assignment"
bioclim_dir<-"/Users/harrington/worldclim_data/wc2.1_30s_bio"    ## bioclim data is downloaded from: https://www.worldclim.org/data/worldclim21.html  -- Bioclimatic variables at 30s -- specific DL link: https://biogeo.ucdavis.edu/data/worldclim/v2.1/base/wc2.1_30s_bio.zip
worldclim_dir<-"/Users/harrington/worldclim_data"   ##    altitude also from https://www.worldclim.org/data/worldclim21.html -- specific download link: https://biogeo.ucdavis.edu/data/worldclim/v2.1/base/wc2.1_30s_elev.zip 
envirem_dir<-"/Users/harrington/environ_layers_non_worldclim/Envirem_NAmerica" ## described here: http://envirem.github.io/  - used current, 30 arcsec, North America set
setwd(main_dir)
...
## Loop over the desired assemblies
...
for(species in assemblies_idb){   ### if we want to loop over all species, this line and line starting "all_assemblies<-c" should be uncommented, as well as final "}"
  ###########################################################
...
## Once this is done for all the coords, don't do it again unless adding in new coords - it takes a while
...
write.csv(all_alt, file="all_coords_altitude.csv")
...
setwd(main_dir)
write.csv(all_cur_bioclim, file="all_coords_current_bioclim.csv")
...
setwd(main_dir)
write.csv(all_cur_envirem, file="all_coords_current_envirem.csv")
