...
k3_fix_root_time_bestlhoods_dir<-"~/Active_Research/Ecotone_genomics/GBS_Data/FSC/Clust_out_best_runs/fix_root_time/K3"



## pick which value of K to go over
k<-"k3_fix_root_time"
...
# set directory for approproiate K value

if(k=="k3_fix_root_time"){
  setwd(k3_fix_root_time_bestlhoods_dir)
}
...
write.csv(vals_and_AIC, paste0("Lgetula_K", k, "_FSC_estimates.csv"))
